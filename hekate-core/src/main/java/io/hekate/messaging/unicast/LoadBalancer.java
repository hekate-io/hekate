 ...
 * {@link #route(Object, LoadBalancerContext)} method of this interface every time when it is going to perform a
 * {@link MessagingChannel#send(Object) send(...)} or {@link MessagingChannel#request(Object) request(...)} operation.
