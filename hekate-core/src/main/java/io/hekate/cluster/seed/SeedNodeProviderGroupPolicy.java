...
/**
 * Error handling policy for {@link SeedNodeProviderGroup}.
 *
 * @see SeedNodeProviderGroupConfig#setPolicy(SeedNodeProviderGroupPolicy)
 */
public enum SeedNodeProviderGroupPolicy {
    /**
     * Fail if at least one {@link SeedNodeProvider} fails.
     */
    FAIL_ON_FIRST_ERROR,

    /**
     * Do not fail if at least one {@link SeedNodeProvider} succeeds.
     */
