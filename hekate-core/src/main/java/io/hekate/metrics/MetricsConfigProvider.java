...
/**
 * Provider of custom metric configurations for {@link MetricsServiceFactory}.
 *
 * <p>
 ...
 * MetricsServiceFactory#setConfigProviders(List)} method.
 * </p>
 *
 * <p>
 * Another approach to register metrics is to use {@link MetricsServiceFactory#setMetrics(List)} method.
 * </p>
 */
public interface MetricsConfigProvider {
    /**
     * Returns a collection of metrics configurations that should be registered within the {@link MetricsService}.
     *
