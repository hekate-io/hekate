 ...
 *
 * <p>
 * Instances of this interface can be registered within the {@link MetricsService} in order to get notifications about metric updates.
 * Listeners can be registered either {@link MetricsServiceFactory#withListener(MetricsListener) statically} or {@link
 * MetricsService#addListener(MetricsListener) dynamically}. Statically registered listeners survive {@link Hekate} node
 * restarts, while dynamically registered listeners will be automatically unregistered when node gets terminated.
 * </p>
 *
 * <p>
 * Listeners gets notified every {@link MetricsServiceFactory#getRefreshInterval()} right after the {@link MetricsService}
 ...
 * @see MetricsServiceFactory#withListener(MetricsListener)
 */
@FunctionalInterface
