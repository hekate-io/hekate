 ...
 * <p>
 * Metrics service can be registered and configured in {@link HekateBootstrap} with the help of {@link MetricsServiceFactory} as shown
 ...
 * ${source: metrics/MetricsServiceJavadocTest.java#configure}
 * </div>
 ...
 * ${source: metrics/service-xsd.xml#example}
 * </div>
 * <div id="configure-bean">
 * <b>Note:</b> This example requires Spring Framework integration
 * (see <a href="{@docRoot}/io/hekate/spring/bean/HekateSpringBootstrap.html">HekateSpringBootstrap</a>).
 * ${source: metrics/service-bean.xml#example}
 * </div>
 * </div>
 *
 * <p>
 * For all available configuration options please see the documentation of {@link MetricsServiceFactory} class.
 * </p>
 *
 ...
 *
 * <p>
 * Counters can be registered within the {@link MetricsService} either at
 * {@link MetricsServiceFactory#withMetric(MetricConfigBase)} configuration time} or dynamically at {@link
 * MetricsService#register(CounterConfig) runtime}. Each counter starts with zero value. Configuration of each counter is
 ...
 * after every {@link MetricsServiceFactory#setRefreshInterval(long) refresh interval};</li>
 * </ul>
 *
 * <p>
 ...
 * ${source: metrics/MetricsServiceJavadocTest.java#counter_example}
 * </p>
 *
 * <h2>Probes</h2>
 * <p>
 ...
 *
 * <p>
 * Probes can be registered within the {@link MetricsService} either at {@link MetricsServiceFactory#withMetric(MetricConfigBase)}
 * configuration time} or dynamically at {@link MetricsService#register(ProbeConfig) runtime}. Configuration of each probe
 ...
 *
 * <p>
 * Once probe is registered, {@link MetricsService} will start polling it in order to obtain and cache the latest value. Polling
 * interval is controlled by the {@link MetricsServiceFactory#setRefreshInterval(long)} configuration option.
 * </p>
 *
 * <p>
 * The code example below illustrates the basic implementation of a probe:
 * ${source: metrics/MetricsServiceJavadocTest.java#probe_example}
 * </p>
 *
 * <h2>Accessing metrics</h2>
 * <p>
 * {@link MetricsService} extends the {@link MetricsSource} interface which provides methods for accessing all registered metrics by
 * their names.
 * </p>
 *
 * <p>
 * Another approach for accessing metrics is to {@link #addListener(MetricsListener) register} an instance of {@link
 * MetricsListener} interface. Such listener will be notified once per {@link MetricsServiceFactory#getRefreshInterval() refresh
 ...
 * ${source: metrics/MetricsServiceJavadocTest.java#listener}
 * </p>
 *
 ...
 * </ul>
 */
@DefaultServiceFactory(MetricsServiceFactory.class)
public interface MetricsService extends Service, MetricsSource {
    /**
     ...
     *
     * <p>
     * Listener will be notified once per {@link MetricsServiceFactory#getRefreshInterval()}.
     * </p>
     *
     * <p>
