 ...
 *
 * <p>
 * Fore more details about metrics and probes please see the documentation of {@link MetricsService}.
 * </p>
 *
 * @see MetricsServiceFactory#withMetric(MetricConfigBase)
 * @see MetricsService#register(ProbeConfig)
 */
public class ProbeConfig extends MetricConfigBase<ProbeConfig> {
     ...
     *
     * <p>
     * This value will be used by the {@link MetricsService} unless it obtains the first real value from the {@link
