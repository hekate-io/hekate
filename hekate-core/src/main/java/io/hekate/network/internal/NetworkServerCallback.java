...
public interface NetworkServerCallback {
    /**
     * Called when server {@link NetworkServer#start(InetSocketAddress) starts} successfully.
     *
     * @param server Server.
     */
    ...
    /**
     * Called when server is {@link NetworkServer#stop() stopped}.
     *
     * @param server Server.
     */
    ...
    /**
     * Called when there is an error either when server is staring or already started.
     *
     * <p>
     * Implementations of this method can provide a custom failover policy. For more details please see "Server failover" section of {@link
     * NetworkServer} javadoc.
     * </p>
     *
     * @param server Server.
