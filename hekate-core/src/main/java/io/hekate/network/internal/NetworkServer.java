 ...
 * <h2>Configuration</h2>
 * <p>
 * Configuration of the standalone TCP server is represented by {@link NetworkServerConfig} class. Please see its javadoc for information
 ...
 * {@link NetworkClient}s. This can be achieved by setting {@link NetworkServerConfig#setAutoAccept(boolean)} option to {@code false}. In
 * this case all clients that are trying to connect will be blocked unless {@link #startAccepting()} method is called.
 * </p>
 *
 * <p>
 ...
 * <h2>Instantiation</h2>
 * <p>
 * Instances of this interface can be obtained via {@link NettyServerFactory#createServer()} method.
 * </p>
 *
 ...
 *
 * <p>
 * The code below provides and example of failover callback implementation:
 * ${source: tcp/server/TcpServerJavadocTest.java#failover_example}
 * </p>
 */
public interface NetworkServer {
     ...
     *
     * <p>
     * This method must be called only if {@link NetworkServerConfig#setAutoAccept(boolean)} is set to {@code false}. If it is set to
     * {@code true} then server will accept connections automatically once it is {@link #start(InetSocketAddress) started}.
     * </p>
     */
    void startAccepting();
