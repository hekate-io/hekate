...
public class DefaultFailoverContextTest extends HekateTestBase {
    ...
    public void test() throws Exception {
        ...
        DefaultFailoverContext ctx = new DefaultFailoverContext(3, new IOException(), Optional.of(failedNode),
            Collections.singleton(failedNode), FailoverRoutingPolicy.RETRY_SAME_NODE);
        ...
        assertEquals(failedNode, ctx.getLastNode().get());
