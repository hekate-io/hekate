...
public abstract class HekateFutureTestBase<V, F extends HekateFuture<V, F>> extends HekateTestBase {
    ...
    public void testGetWithTimeout() throws Exception {
        ...
        assertSame(val, fut.sync(1, TimeUnit.MILLISECONDS));
    }
    ...
    public void testGetError() throws Exception {
        ...
        try {
            ...
            assertEquals(HekateExecutionException.class, err.getClass());
    ...
    public void testGetWithTimeoutError() throws Exception {
        ...
        try {
            fut.sync(1, TimeUnit.MILLISECONDS);
